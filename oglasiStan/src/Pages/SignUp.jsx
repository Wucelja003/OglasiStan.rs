    ...
    <div className='min-h-screen flex' style={{ background: '#FAF7F2' }}>
        ...
        <div className='relative z-10 flex flex-col justify-between p-12 text-white w-full'>
          ...
          <div>
            <div className='inline-flex items-center gap-2 rounded-full px-3 py-1 mb-5'
              ...
              <span className='text-xs font-bold uppercase tracking-widest' style={{ color: '#E07B2A' }}>Pridruži se</span>
            </div>
            <h2 className='font-extrabold mb-4 leading-tight'
              style={{ fontSize: 'clamp(2rem, 3.5vw, 3rem)', letterSpacing: '-0.02em' }}>
              Počni svoju<br />priču.
            </h2>
            <p className='text-base max-w-md leading-relaxed mb-6' style={{ color: 'rgba(255,255,255,0.7)' }}>
              Kreiraj nalog i objavi svoj prvi oglas — besplatno, bez provizije.
            </p>

            {/* Mini benefiti */}
            <div className='flex flex-col gap-2.5'>
              {['Bez skrivenih troškova', 'Direktna komunikacija', 'Hiljade aktivnih korisnika'].map(t => (
                <div key={t} className='flex items-center gap-2.5 text-sm' style={{ color: 'rgba(255,255,255,0.85)' }}>
                  <div className='w-5 h-5 rounded-md flex items-center justify-center flex-shrink-0'
                    style={{ background: 'rgba(224,123,42,0.25)' }}>
                    <svg className='w-3 h-3' fill='none' viewBox='0 0 24 24' stroke='#E07B2A' strokeWidth={3}>
      ...
      <div className='w-full lg:w-1/2 flex items-center justify-center px-6 py-12'>
        <div className='auth-card w-full max-w-md'>
          ...
          <div className='mb-8'>
            <p className='text-xs font-bold uppercase tracking-widest mb-2' style={{ color: '#E07B2A' }}>Registracija</p>
            <h1 className='text-3xl font-extrabold' style={{ color: '#1A1612', letterSpacing: '-0.02em' }}>
              Kreiraj nalog
            </h1>
            <p className='text-sm mt-2' style={{ color: '#6B6158' }}>
              Brz proces — par sekundi i spreman si za prvi oglas.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
            ...
            <button
              disabled={loading}
              className='auth-row-4 mt-2 w-full font-bold py-3.5 rounded-xl text-sm uppercase tracking-wider transition-all duration-200 disabled:opacity-60 text-white flex items-center justify-center gap-2'
          ...
          <p className='text-center text-sm mt-6' style={{ color: '#6B6158' }}>
            Već imate nalog?{' '}
            <Link to='/sign-in' className='font-bold transition-colors' style={{ color: '#E07B2A' }}>
              Prijavi se
            </Link>
          </p>

          <p className='text-center text-xs mt-4' style={{ color: '#B5AFA5' }}>
            Kreiranjem naloga prihvataš naše uslove korišćenja.
          </p>
        </div>
      </div>
    </div>
